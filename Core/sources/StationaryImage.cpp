...
StationaryImage::StationaryImage(double x, double y, double z): Point(x,y,z) 
{
}

void StationaryImage::setX(double x)
{
	//throw("Error in StationaryImage.cpp::setX(double) const value cannot be changed!");
}

void StationaryImage::setY(double y)
{
	//throw("Error in StationaryImage.cpp::setY(double) const value cannot be changed!");
}

void StationaryImage::setZ(double z)
{
